...
symbolicAntiD <- function(form, ...){
  ...
  #--------------------------
  #The highest level operation is a simple arithmetic operator
  ...
  #-------------------------- 
  #The highest level operation is in the math class
  ...
  #-------------------------
  #Called from intArith with operation '/', num and den are the numerator and denominator.
